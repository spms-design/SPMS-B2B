  ...
  const handleDownloadQuotePdf = async () => {
    ...
    try {
      ...
      const sectionBoundaries = Array.from(sourceElement.querySelectorAll('[data-pdf-section]'))
        .map((section) => ({
          start: Math.round((section.offsetTop / sourceElement.scrollHeight) * canvas.height),
          end: Math.round(((section.offsetTop + section.offsetHeight) / sourceElement.scrollHeight) * canvas.height)
        }))
