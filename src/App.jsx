...
export default function App() {
  ...
  const handleRequestProduct = (e) => {
    ...
    const newRequest = {
      ...
      imageUrl: imageInputMode === IMAGE_INPUT_MODES.externalUrl ? productForm.imageUrl : '',
      localImages: imageInputMode === IMAGE_INPUT_MODES.externalUrl ? null : [...uploadedImages]
    };
