  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div className="w-full p-3 bg-amber-50 rounded-xl border border-amber-200 text-[11px] text-amber-900 leading-normal font-bold">
        ...
        <div className="w-full bg-slate-900 text-white p-4 rounded-xl space-y-2 font-semibold">
